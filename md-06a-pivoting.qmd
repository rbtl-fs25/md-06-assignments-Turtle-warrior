...
2.  What's the `tidyverse` Package? Describe in maximum two sentences below.
    ...
    The tidyverse is a package that helps read, clean, structure and nicely visualize data.
...
2.  Execute the code and observe the output in the Console. Would you publish this table in a report in this format?
    ...
    Yes but maybe with some more infos and I think a visualization would be more valuable
...
ggplot(data = waste_data_long_mean,
  ...
  scale_fill_manual(values = c("high income" = "lightblue", 
                               "upper-middle income" = "blue", 
                               "lower-middle income" = "lightgreen", 
                               "low income" = "darkgreen"))
